...
#include "../ReadWriteFiles/ReadWrite.cpp"
...
int main()
{
	...
	readConfigFile(watchdogTime, catch_up_delay, x, INPUT_PIN, new_char_array, length); // reading from config to adjust variables
	...
	ioctl(watchdog, WDIOC_GETTIMEOUT, &watchdogTime);
